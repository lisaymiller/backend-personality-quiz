        ...
        public void run(String... args) throws Exception {
                ...
                if (quizRepo.findAll().isEmpty()) {
                        ...
                        this.quizRepo.save(new Quiz("What Quality Is Most Attractive to You?", "A.Sense of humor",
                                        "B. Intelligence", "C. Thoughtfulness", "D. Great communication skills",
                                        "E. People who are unapologetically themselves"));
                        this.quizRepo.save(new Quiz("What Is Your Karaoke Song?", "A. Mr. Brightside - The Killers",
                                        "B. Total Eclipse of The Heart - Bonie Tyler", "C. Summer Lovin' - Grease",
                                        "D. Fat Lip - Sum 41", "E. Cheeseburger in Paradise - Jimmy Buffett"));
                        this.quizRepo.save(new Quiz("How Do You Celebrate Your Birthday?", "A. Dinner out", "B. Eating",
                                        "C. A vacation with my significant other",
                                        "D. A party with close friends and family", "E. With close friends"));
                        ...
                        this.quizRepo.save(new Quiz("If You Could Live Anywhere, Where Would It Be?",
                                        "A. Pacific Northwest", "B. Manhattan, NY", "C.Charlotte, NC", "D. Lima, Peru",
                                        "E. I'm happy with where I am and what I have"));
                        this.quizRepo.save(new Quiz("What could you eat A LOT of?", "A. Potato chips", "B. Watermelon",
                                        "C. Pizza", "D. Chicken Pad Thai", "E. Ice cream"));
                        this.quizRepo.save(new Quiz("Pick a Fictional Hangout Spot", "A. Hogwarts, Harry Potter",
                                        "B. Jellyfish Fields, Sponge Bob", "C. MacLaren's Pub, HIMYM",
                                        "D. The Honker Burger, Doug", "E. Anywhere with the Parks and Rec group"));
                        this.quizRepo.save(new Quiz("Danger's Afoot. No Time To Wait For Backup. What Do You Do?",
                                        "A. Call a friend",
                                        "B. Pick a hiding spot and observe the situation from a distance",
                                        "C. Evacuate!",
                        ...
                        this.quizRepo.save(new Quiz("What Would Make You Happiest On a Work Day?", "A. Go Home",
                                        "B. Working on a project I feel passionate about", "C. Completing a project",
                                        "D. Cute animal pictures", "E. A team effort resulting in a positive outcome"));
                        this.quizRepo.save(new Quiz("What's Your Motto to Live By?",
                                        "A. Work to live, don't live to work", "B. Do the best with what you have",
                                        "C. Keep on keeping on", "D. The only constant is change",
